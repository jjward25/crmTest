        ...
        <div className={cn("space-y-4")}>
          ...
          <div className={cn("grid grid-cols-2 gap-4")}>
            <div className={cn(
              ...
              <div className="text-xs text-primary-1 mb-1">Annual Revenue</div>
            ...
            <div className={cn(
              ...
              <div className="text-xs text-primary-1 mb-1">ARR</div>
              <div className="text-lg font-semibold text-primary-2">
          ...
          <div className={cn(
            ...
            <div className="text-xs text-primary-1 mb-2">Use Cases</div>
