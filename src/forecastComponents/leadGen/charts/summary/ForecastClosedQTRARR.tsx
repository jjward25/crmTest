...
export default function ForecastClosedQtrARR() {
  ...
  return (
    <div className="border border-primary-3 p-4 rounded-md bg-primary-5 w-full">
      <h3 className="text-primary-2 font-semibold mb-2">Open & Close Next Quarter</h3>
      <p className="text-primary-1 text-3xl font-bold">${(Math.round(projectedARR *.4 *.55)).toLocaleString()}</p>
    </div>
  );
}