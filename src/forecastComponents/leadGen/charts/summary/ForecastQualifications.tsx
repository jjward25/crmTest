...
export default function QualificationsForecast() {
  ...
  return (
    <div className="border border-primary-3 p-4 rounded-md bg-primary-5 w-full">
      <h3 className="text-primary-2 font-semibold mb-2">New Qualifications</h3>
      <p className="text-primary-1 text-3xl font-bold align-top">{forecast+10} <span className="ml-0 text-xs align-top text-gray-400">{`(134 leads)`}</span></p>
    </div>
  );
}